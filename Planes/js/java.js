...
document.getElementById("paymentForm").addEventListener("submit", function(e) {
    ...
    inputs.forEach(input => {
        if (input.value.trim() === "") {
            valid = false;
            input.style.borderColor = "red"; // campo vacío 
        } else {
            input.style.borderColor = "#ccc"; // restablecer
        }
    });
    ...
    Swal.fire({
        title: "¡Pago enviado!",
        text: "Tu información se envió correctamente. Revisa tu correo electrónico.",
        icon: "success",
